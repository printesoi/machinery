[1]: https://raw.githubusercontent.com/printesoi/assets/master/machinery/example_worker.png
[2]: https://raw.githubusercontent.com/printesoi/assets/master/machinery/example_worker_receives_tasks.png
...
import (
  ...
  backendsiface "github.com/printesoi/machinery/v2/backends/iface"
  brokersiface "github.com/printesoi/machinery/v2/brokers/iface"
  locksiface "github.com/printesoi/machinery/v2/locks/iface"
)
...
```sh
go get github.com/printesoi/machinery/v2
```

If you want to use legacy v1 version, you still can:

```sh
go get github.com/printesoi/machinery/v1
```
...
> Keep in mind AMQP is not recommended as a result backend. See [Keeping Results](https://github.com/printesoi/machinery#keeping-results)
...
Then just set the logger in your setup code by calling `Set` function exported by `github.com/printesoi/machinery/v1/log` package:
