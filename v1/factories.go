...
import (
	...
	amqpbroker "github.com/printesoi/machinery/v1/brokers/amqp"
	eagerbroker "github.com/printesoi/machinery/v1/brokers/eager"
	gcppubsubbroker "github.com/printesoi/machinery/v1/brokers/gcppubsub"
	brokeriface "github.com/printesoi/machinery/v1/brokers/iface"
	redisbroker "github.com/printesoi/machinery/v1/brokers/redis"
	sqsbroker "github.com/printesoi/machinery/v1/brokers/sqs"

	amqpbackend "github.com/printesoi/machinery/v1/backends/amqp"
	dynamobackend "github.com/printesoi/machinery/v1/backends/dynamodb"
	eagerbackend "github.com/printesoi/machinery/v1/backends/eager"
	backendiface "github.com/printesoi/machinery/v1/backends/iface"
	memcachebackend "github.com/printesoi/machinery/v1/backends/memcache"
	mongobackend "github.com/printesoi/machinery/v1/backends/mongo"
	nullbackend "github.com/printesoi/machinery/v1/backends/null"
	redisbackend "github.com/printesoi/machinery/v1/backends/redis"

	eagerlock "github.com/printesoi/machinery/v1/locks/eager"
	lockiface "github.com/printesoi/machinery/v1/locks/iface"
	redislock "github.com/printesoi/machinery/v1/locks/redis"
)
